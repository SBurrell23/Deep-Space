...
export const ACHIEVEMENTS = [
  ...
  { id: 'derelict_20', cat: 'Exploration', name: 'Everything Not Nailed Down', icon: 'node_derelict',
    desc: 'Clear 20 derelicts in one run.',
    check: c => (c.run.stats.derelictsCleared || 0) >= 20 },
