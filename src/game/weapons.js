...
export const WEAPONS = {
  ...
  vortex: {
    ...
    speed: 210, life: 3.4, count: 1, radius: 130, splashMult: 1, pullForce: 320,
    tickRate: 6, tickDamage: 5,
  ...
  gravity_well: {
    ...
    speed: 190, life: 4.5, count: 1, radius: 175, splashMult: 1, pullForce: 620,
    tickRate: 8, tickDamage: 9,
  ...
  singularity: {
    ...
    behaviour: 'aoe', damage: 350, rof: 0.10, energy: 52,
    speed: 240, life: 3.2, count: 1, radius: 250, splashMult: 0.9, pullForce: 780,
    tickRate: 4, tickDamage: 30,
  ...
  sunlance: {
    ...
    behaviour: 'pierce', damage: 430, rof: 0.11, energy: 56,
  ...
  warhead_salvo: {
    ...
    behaviour: 'homing', damage: 100, rof: 0.13, energy: 50,
  ...
  seismic_charge: {
    ...
    behaviour: 'charge', damage: 275, rof: 0.13, energy: 46,
  ...
  ion_storm: {
    ...
    behaviour: 'chain', damage: 330, rof: 0.14, energy: 48,
    speed: 1200, life: 1.2, count: 1, chains: 10, chainRange: 300, chainFalloff: 0.96,
  ...
  fracture_cannon: {
    ...
    behaviour: 'fragment', damage: 165, rof: 0.13, energy: 50,
    speed: 520, life: 1.6, count: 1, fragments: 14, fragmentDamage: 40, fragmentSpeed: 400,
  ...
  void_anchor: {
    ...
    // Nearly stationary on purpose: at 130px/sec the "anchor" outran whatever
    // it caught and did less than half the damage of the next weakest weapon
    // in the slot. It plants itself, drags a formation in, and grinds.
    behaviour: 'aoe', damage: 55, rof: 0.09, energy: 54,
    speed: 55, life: 7, count: 1, radius: 170, splashMult: 0.8, pullForce: 900,
    tickRate: 9, tickDamage: 14,
    sprite: 'pb_plasma', sound: 'temporal', icon: 'icon_sys_temporal',
  },
};
