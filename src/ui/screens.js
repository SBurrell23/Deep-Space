  ...
  body.append(
    ...
    section('Flying',
      el('div.keygrid', null,
        ...
        keyRow('1 / 2 · Q / E', 'Abilities from your utility gear'),
        keyRow('I', 'Ship and loadout'),
        keyRow('Esc', 'Pause')),
    ...
    section('Getting stronger',
      ...
      p('Gear fills nine slots — two weapons, engine, shield, reactor, plating, nav computer and two utility slots. Utility items are what grant active abilities.'),
